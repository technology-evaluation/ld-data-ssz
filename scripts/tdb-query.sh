...
tdbupdate --loc=target/tdb_ssz --update=sparql/sparql/themenbaum-level1-3.rq
tdbupdate --loc=target/tdb_ssz --update=sparql/sparql/themenbaum-level1-2.rq
tdbupdate --loc=target/tdb_ssz --update=sparql/sparql/themenbaum-level1.rq
